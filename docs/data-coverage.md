...
Canonical game details were expanded in 3.8.0. Steam achievements and PSN
trophies use one normalized unlock shape but remain in separate progress sets.
Regional PSN records are deduplicated by service and trophy-set ID. Progress
reads cached detail snapshots only, preserves healthy sets during partial
failures, and never changes canonical playtime selection.
